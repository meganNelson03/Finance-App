$(document).ready(function() {
  ...
  $(".change-theme-button").on("click", () => {
    toggleStates(["body", ".navbar-light", ".fa-money-bill-wave", ".change-theme-button", ".navbar-light .nav .nav-link", ".close-forms", ".income-total", ".expense-total", ".index-hr", ".amount-container", ".form-section input", ".form-section select", "::placeholder"], "data-state", "dark", "light");
